...
function flatten(object) {
  ...
  for(var i in object){
    if (i == 'name') {
      ...
      for(var k in object.batch){
        if (k == 'number') {
          obj[[i]+'.'+[k]] = object.batch[k]
        } else if (k == 'name') {
          obj[[i]+'.'+[k]] = object.batch[k]
        }
      }
    ...
    if (i == 'father') {
      for(var k in object.father){
        if (k == 'name') {
          obj[[i]+'.'+[k]] = object.father.name
        } else if (k == 'age') {
          obj[[i]+'.'+[k]] = object.father.age
        }
      }
    } else if (i == 'mother') {
      for(var k in object.mother){
        if (k == 'name') {
          obj[[i]+'.'+[k]] = object.mother.name
        } else if (k == 'age') {
          obj[[i]+'.'+[k]] = object.mother.age
        }
      }
    }
  }
